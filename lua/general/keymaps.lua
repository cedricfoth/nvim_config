...
keymap("n", "<leader>rn", vim.lsp.buf.rename, { noremap = true, silent = true, desc = "Rename" })
...
keymap("n", "K", vim.lsp.buf.hover, { noremap = true, silent = true, desc = "Hover" })
...
keymap("n", "gr", vim.lsp.buf.references, { noremap = true, silent = true, desc = "Go to Reference" })
