return {
  ...
  config = function()
    ...
    keymap.set("n", "<leader>fp", "<cmd>Telescope bibtex format_string=\\citep{%s}<cr>", { desc = "Find Lieterature (Format \\cite{})" })
    keymap.set("n", "<leader>fr", "<cmd>Telescope git_commits<cr>", { desc = "Find Lieterature (Format \\cite{})" })
  end,
}
